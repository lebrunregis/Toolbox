...
namespace Parabox
{
    ...
    public static class SymlinkUtility
    {
        ...
        static void Symlink(SymlinkType linkType)
        {
            ...
            SymlinkTool.Symlink(linkType, sourceFolderPath, targetPath);
        }
    ...
    public class SymlinkTool
    {

        public static void Symlink(SymlinkType linkType, string sourceFolderPath, string targetPath)
        {
